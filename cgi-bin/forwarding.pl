...
my $rules = $ipt_obj->chain_rules('filter', 'FORWARD');# select FILTER table and FORWARD part of the status.log file.
#
...
<title>forwarding traffic - firewall web panel</title>
</head>
    ...
    <div class="form-all">
        <ul class="form-section">
			...
			<li class="form-line form-line-column" id="id_5">
                <label class="form-label-top" id="label_5" for="input_5"> in. interface </label>
                <div id="cid_5" class="form-input-wide">
                    <input type="text" class="form-textbox" id="interface" name="in_interface" size="14" />
                </div>
            </li>
			<li class="form-line form-line-column" style="margin-left:42px;" id="id_5">
                <label class="form-label-top" id="label_5" for="input_5"> out. interface </label>
                <div id="cid_5" class="form-input-wide">
                    <input type="text" class="form-textbox" id="interface" name="out_interface" size="14" />
                </div>
            </li>
...
EOHTML
# generating numbers for priority drop-down menu according to available rules in the FORWARD chain.
...
print<< 'EOHTML';
            ...
            <li class="form-line form-line-column" id="id_7">
                <label class="form-label-top" id="label_7" for="input_7"> source port </label>
                <div id="cid_7" class="form-input-wide">
                    <input type="text" class="form-textbox" id="source_port" name="source_port" size="16" maxlength="5" />
                </div>
            </li>
...
#     
	 ...
	 print "<tr><td>" . ($rule_num) . "</td>\n";#rule number = array's index +1.
	 print "<td>" . $rules->[$i]->{"src"} ."(" . $rules->[$i]->{"s_port"} . ")</td>\n";
	 print "<td>" . $rules->[$i]->{"dst"} ."(" . $rules->[$i]->{"d_port"} . ")</td>\n";
	 print "<td>" . $rules->[$i]->{"intf_in"} ."/" . $rules->[$i]->{"intf_out"} . "</td>\n";
	 print "<td>" . $rules->[$i]->{"protocol"} . "</td>\n";
